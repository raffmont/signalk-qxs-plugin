...
- POST /plugins/kip/displays/{$uuid}/activeScreen body: {"changeId": } - Given the display identified by the $uuid UUID, set as active dashboard the one identified by the UUID given by the changeId parameter.
